...
# Entrada
# Seu programa deve solicitar ao usuário a entrada de um número inteiro positivo, representando a 
# quantidade de passos que o explorador deve dar na floresta. 
...
# TODO: Se a quantidade de passos for zero, imprima "Nenhum passo dado na floresta."
# TODO: Caso contrário, utilize um loop for para imprimir a mensagem do explorador, indicando o número do passo.
