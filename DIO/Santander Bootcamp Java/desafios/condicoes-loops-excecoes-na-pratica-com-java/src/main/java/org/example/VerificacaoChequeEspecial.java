...
Descrição
Você está desenvolvendo um programa simples em Java para verificar se uma conta bancária ultrapassou o limite
do cheque especial. A aplicação solicitará ao cliente que informe o saldo atual da conta bancária. Em seguida, o programa pedirá o valor de um saque que o cliente deseja realizar.
...
public class VerificacaoChequeEspecial {
    ...
    public static void main(String[] args) {
        ...
        if (saque <= saldo) {
            ...
            if (saldoFinal >= -limiteChequeEspecial) {
